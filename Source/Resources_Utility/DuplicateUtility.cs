	...
	public static class DuplicateUtility
	{
		...
		public static void DuplicationOutcomes(Pawn caster, Pawn originalPawn, Pawn duplicatePawn, bool randomOutcome, out string customLetter, out LetterDef letterDef)
		{
			...
			try
			{
				...
				//catch
				//{
				//	Log.Error("Failed do outcome, trying do legacy one.");
				//	LegacyOutcomes(caster, originalPawn, duplicatePawn, ref customLetter, ref letterDef, ref phase);
				//}
			}
			catch (Exception arg)
			{
		...
		public static void RandomizeBackstory(Pawn duplicatePawn, ref string customLetter)
		{
		...
		public static void RandomizeTraits(Pawn duplicatePawn, ref string customLetter)
		{
		...
		public static void MakeHostile(Pawn caster, Pawn originalPawn, Pawn duplicatePawn, ref LetterDef letterDef, ref string customLetter)
		{
		...
		//public static Pawn GetSourceCyclic_ToMe(this Pawn duplicate, Pawn requester)
		//{
		...
		//		return duplicate;
		//	}
		//	if (sourcePawn == null || sourcePawn == duplicate || requester == duplicate)
		//	{
		//		return duplicate;
		//	}
		//	return GetSourceCyclic_ToMe(sourcePawn, requester);
		//}
