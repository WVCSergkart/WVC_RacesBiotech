...
namespace WVC_XenotypesAndGenes
{
	...
	public class Gene_ThrallMaster : Gene_ThrallMaker
	{
		...
		// public float GetConsumedGolembond()
		// {
			// foreach (Pawn golem in ControlledThralls)
			// {
	...
	public class Gene_Thrall : Gene
	{
		...
		// [Unsaved(false)]
		// private int cachedThrallBondCost;
		// [Unsaved(false)]
		// private bool shouldCacheBondCost = true;

		// public int ThrallBondCost
		// {
			// get
			// {
				// if (shouldCacheBondCost)
				// {
					// cachedThrallBondCost = XaG_GeneUtility.GetPawn_Arc(pawn);
					// shouldCacheBondCost = false;
				// }
				// return cachedThrallBondCost;
			// }
		// }
