...
namespace WVC_XenotypesAndGenes
{
	...
	public class Gene_Archiver : Gene_Morpher
	{
		...
		private void BeforeDrop(PawnContainerHolder holder)
		{
			...
			if (ticks > 0)
			{
				HealingUtility.Regeneration(holder.holded, regeneration: 50, ignoreScarification: true, tick: ticks, regenEyes: HealingUtility.ShouldRegenerateEyes(holder.holded));
			}
		}
