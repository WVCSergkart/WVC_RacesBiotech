...
namespace WVC_XenotypesAndGenes
{
	...
	public class Gene_AutoResearch : Gene, IGeneNotifyGenesChanged
	{
        ...
        public void DoResearch(int tick, int delta)
		{
			...
			{
				pawn.skills.Learn(SkillDefOf.Intellectual, 0.04f * tick * delta);
                float amount = (cachedResearchSpeed.Value * tick * delta) - (StaticCollectionsClass.cachedColonistsCount > 1 ? StaticCollectionsClass.cachedColonistsCount * 12.8f : 0f);
