...
namespace WVC_XenotypesAndGenes
{
	...
	public class Gene_BottomlessBelly : XaG_Gene
	{
		...
		public override void Notify_IngestedThing(Thing thing, int numTaken)
		{
			...
			{
				GeneResourceUtility.OffsetNeedFood(pawn, (thing.def.ingestible.CachedNutrition * -0.5f) * numTaken, false);
			}
		}
	...
	[Obsolete]
	public class Gene_Dustogenic : Gene_BottomlessBelly
	{
		//public string RemoteActionName => XaG_UiUtility.OnOrOff(autoFeed);

		//public TaggedString RemoteActionDesc => "WVC_XaG_RemoteControlDustogenicDesc".Translate();
