...
namespace WVC_XenotypesAndGenes
{
	...
	public class GeneGizmo_Thralls : Gizmo
	{
        ...
        {
            LabelAndDesc(topLeft, maxWidth, out Rect rect2, out Rect rect3, out _);
        ...
        private void LabelAndDesc(Vector2 topLeft, float maxWidth, out Rect rect2, out Rect rect3, out TaggedString taggedString)
        {
