...
namespace WVC_XenotypesAndGenes
{
	...
	public class GeneGizmo_Morpher : Gizmo
	{
		...
		public static Thing GetBestArchiteStack(Pawn pawn, bool forced)
		{
			...
			return GenClosest.ClosestThingReachable(pawn.Position, pawn.Map, ThingRequest.ForDef(ThingDefOf.ArchiteCapsule), PathEndMode.Touch, TraverseParms.For(pawn, danger), 9999f, delegate (Thing t)
			{
				Thing chunk = t;
