...
namespace WVC_XenotypesAndGenes
{
	...
	public class WVC_BiotechSettings : ModSettings
	{
		...
		public float voidlink_mechCostFactor = 3f;
		public float voidlink_mechCostLimit = 99f;
		public float voidlink_resourceGainFromMechsFactor = 0.01f;
		...
		// Chimera
		public bool enable_dynamicGeneMetabolism = true;
		...
		public override void ExposeData()
		{
			...
			Scribe_Values.Look(ref bloodeater_HideAbilitiesByDefault, "bloodeater_HideAbilitiesByDefault", defaultValue: false);
			...
			Scribe_Values.Look(ref shapeshifer_reqMinBaseGenesMatch, "shapeshifer_BaseGenesMatch", defaultValue: 0.7f);
			...
			// Chimera
			Scribe_Values.Look(ref enable_dynamicGeneMetabolism, "enable_chimeraMetabolismHungerFactor", defaultValue: true);
			...
			Scribe_Values.Look(ref disableXenotypes_Hivemind, "disableXenotypes_Hivemind", defaultValue: false);
	...
	public class WVC_Biotech : Mod
	{
		...
		public void ExtraSettings(Rect inRect)
		{
			...
			ResetButton(listingStandard);
			// =============== Dev Mode ===============
			XaG_UiUtility.DevOptions(listingStandard, this);
			listingStandard.End();
			Widgets.EndScrollView();
		}
		...
		public void GenesSettings(Rect inRect)
		{
			...
			if (collapse_genesSettings_general)
			{
				...
				listingStandard.CheckboxLabeled("WVC_Label_enable_dynamicGeneMetabolism".Translate(), ref settings.enable_dynamicGeneMetabolism, "WVC_ToolTip_enable_dynamicGeneMetabolism".Translate());
			...
			if (collapse_genesSettings_Hemogenic)
			{
				...
				listingStandard.CheckboxLabeled("WVC_Label_bloodeater_HideAbilitiesByDefault".Translate(), ref settings.bloodeater_HideAbilitiesByDefault, "WVC_ToolTip_bloodeater_HideAbilitiesByDefault".Translate());
			...
			if (collapse_genesSettings_Shapeshifer)
			{
				...
				listingStandard.SliderLabeledWithRef("WVC_Label_shapeshifer_BaseGenesMatch".Translate(settings.shapeshifer_reqMinBaseGenesMatch.ToStringPercent()), ref settings.shapeshifer_reqMinBaseGenesMatch, 0f, 1f, round: 2, tooltip: "WVC_Tooltip_shapeshifer_BaseGenesMatch".Translate());
		...
		public void XenotypesSettings(Rect inRect)
		{
			...
			listingStandard.CheckboxLabeled("WVC_Label_disableXenotypes_Hivemind".Translate(), ref settings.disableXenotypes_Hivemind, "WVC_ToolTip_disableXenotypes_Hivemind".Translate());
		...
		public static void ResetSettings_ByTemplate(SettingsDef settingsDef)
		{
			...
			WVC_Biotech.settings.bloodeater_HideAbilitiesByDefault = settingsDef.bloodeater_HideAbilitiesByDefault;
			...
			WVC_Biotech.settings.disableXenotypes_Hivemind = settingsDef.disableXenotypes_Hivemind;
